...
namespace Toolbox.Attributes.Self
{
    public static partial class Helper
    {
        private static IEnumerable<MethodInfo> GetAllMethods(this Type? type, string name) =>
        ...
        private static IEnumerable<PropertyInfo> GetAllProperties(this Type? type, string name) =>
            GetAllProperties(type, info => info.Name.Equals(name, StringComparison.Ordinal));

        private static IEnumerable<MethodInfo> GetAllMethods(this Type? type, Func<MethodInfo, bool>? predicate = null)
        {
        ...
        private static IEnumerable<FieldInfo> GetAllFields(this Type? type, Func<FieldInfo, bool>? predicate = null)
        {
            if (type == null) yield break;
